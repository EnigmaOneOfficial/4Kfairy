...
const SongCard = ({ songs }: SongCardProps) => {
  ...
  // Update the getSongDuration function
  ...
  return (
    <div className={styles.container}>
      {selectedSong && <AudioVisualizer audioElement={audioRef.current!} />}
      <div className={styles.controlsCard} style={controlsCardStyle}>
        {selectedSong ? (
          <>
            <h2 className={styles.title}>{selectedSong.title}</h2>
            <audio
              src={selectedSong.mp3Url}
              ref={audioRef}
